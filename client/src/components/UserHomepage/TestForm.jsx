    ...
    if (selectedFile) {
      ...
      reader.onload = (event) => {
        ...
        if (lines.length < 40 && lines.length > 10000) {
          setMessage(
            "File contains less than 40 rows or more than 10000 rows. Please choose a valid file."
          );
                      ...
                      <div className="flex flex-wrap mx-3 mb-6">
                        ...
                        <div class="flex items-center justify-center w-full">
                          <form onSubmit={handleFileFormSubmit}>
                            <label
                              for="dropzone-file"
                              class="md:p-5 flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover.bg-gray-100 my-5"
                            >
