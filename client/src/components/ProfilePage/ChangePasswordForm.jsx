                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full md:w-full px-3 mb-6">
                            ...
                            <input
                                ...
                                type={showPassword ? 'text' : 'password'} name="currentPassword" onChange={handleInputChange} value={formData.currentPassword}
                                required
                            />
                        </div>
                        ...
                        <div className="w-full md:w-full px-3 mb-6">
                            ...
                            <input
                                className={`${inputFieldClass}`}
                                type={showPassword ? 'text' : 'password'} name="newPassword" onChange={handleInputChange}
                                value={formData.newPassword} required
                            />
                        </div>
                        ...
                        <div className="w-full md:w-full px-3 mb-6">
                            ...
                            <input
                                className={`${inputFieldClass}`}
                                type={showPassword ? 'text' : 'password'} name="confirmNewPassword" onChange={handleInputChange} value={formData.confirmNewPassword}
                                required
                            />
                        </div>
