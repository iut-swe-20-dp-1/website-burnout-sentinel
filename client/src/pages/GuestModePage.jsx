            ...
            <main>
              <div className="pt-6 px-4">
                <UserHomepageCards
                  ...
                  setBaseDataExists={setBaseDataExists}
                  setShowAddBaseDataForm={setShowAddBaseDataForm}
                  setShowUpdateBaseDataForm={setShowUpdateBaseDataForm}
                ...
                {showTestForm && (
                  <TestForm
                    setShowTestForm={setShowTestForm}
                    guest={true}
                    form_title={`Start Your Stress Assessment`}
                    lottie_animation_data={TakeTestAnimation}
                  />
                )}
              </div>
            </main>
