  ...
  const dummyData = [
    {
      ...
      redirect_link:
        "https://www.google.comhttps://www.unh.edu/pacs/academic-stress-coping-strategies",
      displayed_link: "https://www.unh.edu › pacs › academic-stress-coping-...",
      favicon:
        "https://serpapi.com/searches/65a7b4f936e6a9beab37ed29/images/db17a988418aec1a2d9b16053fd9c5f0107971e16f522d01d3877cdd8250cd0f.png",
      snippet:
    ...
    },
    {
      ...
      redirect_link:
        "https://www.google.comhttps://oconnorpg.com/blog/10-tips-deal-academic-stress/",
      displayed_link: "https://oconnorpg.com › Blog",
      favicon:
        "https://serpapi.com/searches/65a7b4f936e6a9beab37ed29/images/db17a988418aec1a2d9b16053fd9c5f0788cbee959bce07a0185a45d272dd509.png",
      date: "Apr 15, 2021",
      snippet:
        "1. Make To Do Lists · 2. Budget Your Time · 3. Create a Rewards System · 4. Ask For Help and Move On · 5. Take Breaks to Breathe · 6. Eat Healthy · 7.",
      snippet_highlighted_words: ["Help"],
          ...
          <div className="pt-6 px-4">
            <div className="container px-6 py-2 mx-auto">
              ...
              <h1 className="text-lg text-center text-[#300722] mx-4 ">
                At Burnout Sentinels, your health matters to us. Explore helpful
                links to websites that offer relaxation techniques and stress
                management strategies. Prioritize your well-being with our
              ...
              {loading? (<><Loading/></>) : (<div className="grid grid-cols-1 gap-8 mt-4 md:mt-8 md:grid-cols-2">
                {suggestionData?.map((item) => (
                  <div
                    key={item.position}
                    className="lg:flex bg-white p-1 rounded-lg border-2 border-[#DFE9F7] transition duration-300 ease-in-out hover:border-[#7366FF]"
                  >
                    <div className="flex items-center justify-center p-2">
                      <img
                        className="object-cover w-full h-20 rounded-lg lg:w-40"
                        src={item.favicon}
                        alt="favicon"
                      />
                    </div>
                    <div className="flex flex-col justify-between py-2 lg:mx-6">
                      <a
                        href={item.link}
                        className="text-2xl mb-2 font-semibold text-[#300722] hover:underline"
                      >
                        {item.title}
                      </a>
