"""
Django settings for burnoutSentinel project.
...
SECRET_KEY = 'django-insecure-rn6s&^orm*221g9#h*m#=s(rhx5-)ba0)82!a0v0x%3aacv@n^'
...
WSGI_APPLICATION = 'burnoutSentinel.wsgi.application'
